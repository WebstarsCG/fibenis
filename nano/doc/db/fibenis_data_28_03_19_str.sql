...
CREATE TABLE IF NOT EXISTS `eav_addon_varchar` (
  ...
  KEY `timestamp_punch` (`timestamp_punch`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=12224 ;
...
CREATE TABLE IF NOT EXISTS `ecb_av_addon_varchar` (
  ...
  KEY `timestamp_punch` (`timestamp_punch`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=28476 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5584 ;
...
CREATE TABLE IF NOT EXISTS `entity_child` (
  ...
  KEY `timestamp_punch` (`timestamp_punch`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4804 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3766 ;
...
CREATE TABLE IF NOT EXISTS `sys_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `timestamp_punch` (`timestamp_punch`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=31162 ;
...
CREATE TABLE IF NOT EXISTS `user_role_page` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_role_id` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `user_role_page_matrix` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=15304 ;
