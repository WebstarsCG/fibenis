<?PHP
	...
	function before_delete($param){
		...
		$lv['folder'] = $param['g']->get_one_cell(['table'=>'eav_addon_varchar',
								...
								parent_id=get_ec_parent_id_eav($parent)" 
						    ]);
		...
		$lv['loc'] = get_config('theme_path').'/'.$lv['folder'].'/blend/'.$lv['file_name'].'.less';
		
		$lv['new'] = get_config('theme_path').'/'.$lv['folder'].'/blend/'.$lv['file_name'].'.css';
