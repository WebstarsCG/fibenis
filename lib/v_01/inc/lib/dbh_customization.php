<?php
	     ...
	     class DB_CUSTOMIZATION{
			  ...
			  function db_limit($start,$per_page){
				       ...
				       $LIMIT_ACTION   = array( 'rdsql_mysql'   => "LIMIT $start,$per_page" ,
			  ...
			  function get_last_insert_id($id_seq){
				       ...
				       $last_insert_id  = array( 'rdsql_mysql'   => "lastInsertID()",
			  ...
			  function get_null_str($id_seq){
				       ...
				       $last_insert_id  = array( 'rdsql_mysql'   => "IFNULL",
			  ...
			  function group_concat($field_id){
				       ...
				       $group_concat   = array( 'rdsql_mysql'  =>  " group_concat(".$field_id.")" ,
