	...
	function  F_Series(){		      
		...
		this.unsetValidationExclude	= function(elements){									
				...
				temp = this.is_must_elements;
				
				for(const element_id of elements){											
					delete this.is_must_elements[element_id];
				} // each element
				
				this.unsetValidation(Object.keys(this.is_must_elements));
		...
		this.setValidationExclude	= function(elements){									
				...
				this.setValidation(Object.keys(this.is_must_elements));
