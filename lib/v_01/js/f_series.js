		...
		this.unsetValidation	= function(elements){									
			...
			if(arguments.length==0){									
				...
				for(const element_id of Object.keys(this.is_must_elements)){
					...
					elementFocusOut(document.getElementById(element_id));
				}									
	...
	function checkIsFormat(element){ return f_series.checkIsFormat(element);}
				  ...
				  F_Series.prototype.setCheckbox=function(element_id){
								...
								console.log(lv.checkboxes.length+'--'+lv.labels.length);
								...
								for(var eidx in lv.checkboxes){
										...
										lv.counter++;
										lv.checkboxes[eidx].id='X'+element_id+'_'+lv.counter;
										lv.checkboxes[eidx].name='X'+element_id+'[]';
																				
										if(isNaN(eidx)!=true){
											lv.labels[eidx].setAttribute("for",'X'+element_id+'_'+lv.counter);
										}
							...
							/* 	lv.counter       = 0;
								...
								//each element
								for(var eidx of lv.checkboxes){
									
										lv.counter++;
										//eidx.id='X'+element_id;
										//eidx.name='X'+element_id+'_'+lv.counter;
										
										eidx.id='X'+element_id+'_'+lv.counter;
										eidx.name='X'+element_id+'[]';
								} */
				...
				F_Series.prototype.setRadio=function(element_id){
								...
								console.log(lv.radios.length+'--'+lv.labels.length);
								...
								for(var eidx in lv.radios){
										...
										lv.counter++;
										lv.radios[eidx].id='X'+element_id+'_'+lv.counter;
										lv.radios[eidx].name='X'+element_id;
