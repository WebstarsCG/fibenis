...
//       So all the display variables have a same source, it should be reflected indentically.
...
function WaitingList(train){		      
    ...
    this.prepare = function(){
            ...
            // capture
            lv.taggedContent = lv.plainContent.replaceAll(this.rx.seat,function(match,p1,p2,p3,p4,p5,offset,str){
                ...
                return `<span data-wl='1' data-id='${p2}${p3}'></span>`;
