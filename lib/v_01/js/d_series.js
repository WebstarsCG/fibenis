	   ...
	   function  D_Series(){		      
			  ...
			  this.css	 	= {'dynamic_label':'fbn_dyn_lbl'},
					...
					this.desk_action = {'SR':'Search','FR':'Filter','DT':'Date Filter','PS':'Page Item Size','PR':'Pager','NA':'No Action'};

			this.desk_current_action ='NA'; 				
			this.desk_prev_action ='NA';
		...
		D_Series.prototype.setDeskAction=function(param){
			this.desk_prev_action	 = this.desk_current_action;
			this.desk_current_action = param;				
		} // end
		
		D_Series.prototype.getDeskAction=function(param){
			return this.desk_current_action;
		} // end
		
		D_Series.prototype.neutralDeskAction=function(){		
			this.setDeskAction(this.getDeskAction());
		} // end
		
		D_Series.prototype.isDeskActionChange=function(param){				
			return (this.desk_current_action!=this.desk_prev_action)?true:false;
		} // end
