	...
	$D_SERIES       =   array(
							...
							3=>array('th'	=> 'Blend', 'th_attr'=>' colspan=2 ',
								...
								'attr' =>  [ 'class'=>"", 'width' => "6%"],
													...
													$data_out = array('id'   => $temp[0],
													 ...
													 'title'=>'View Blend Types',
												         'src'=>"?d=theme__blend_source&menu_off=1&mode=simple&default_addon=$temp[0]",
							...
							4=>array('th'	=> '',
								  ...
								  'filter_out'=>function($data_in){
													...
													'title'=>'Add Blend Type',
													'src'=>"?f=theme__blend_source&menu_off=1&mode=simple&default_addon=$data_in",
													'style'=>"border:none;width:100%;height:600px;"
												  );
				...
				#check_field
					...
					'add_button' => array( 'is_add' =>1,'page_link'=>'f=theme', 'b_name' => 'Add Theme' ),
