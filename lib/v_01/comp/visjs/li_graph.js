 function htmlListToGraphData(id) {
                 ...
                 lv.token_map=new Object({2:'B'});
                                               ...
                                               lv.nodeLabel =  String(lv.element.dataset.label).replace( "&gt;",'').replace("&lt;",'').replace(/_/g,'');
                                               this.nodeRef[lv.parentElement.id]=this.nodeCounter+this.getLabelWithClass(lv.nodeLabel,lv.element.className);
                                               ...
                                               lv.nodeLabel =  String(lv.currentList.dataset.label).replace( "&gt;",'').replace("&lt;",'').replace(/_/g,'');
                                               lv.nodeLabelCheck ='';
                                               ...
                                               //console.log('HP'+lv.currentList.id+'-->'+lv.currentList.dataset.hasprop+'--'+lv.currentList.dataset.label);
                                               
                                               if(lv.currentList.dataset.hasprop==1) {
                                                     lv.edgeType='&&--&&';                                               //code                                                                             
                                               }else if(lv.currentList.dataset.hascomp==1) {
                                                     lv.edgeType='&--&';                                               //code                                                                             
                                               }else if(lv.currentList.dataset.hassubtyp==1) {
                                                     lv.edgeType='!!--!!';                                               //code                                                                             
                                               }else{
                                                     lv.edgeType='-->';                                          
                                               }
                                               ...
                                               this.edges.push(this.nodeRef[lv.parentElement.id]+lv.edgeType+this.nodeRef[lv.currentList.id]+lv.nodeLabelCheck);
