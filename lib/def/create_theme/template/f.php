<?PHP
     ...
     $F_SERIES	=	array(
				...
				'data'	=>   array(
						...
						//		 
						//		 'filter_out'	=> $FILTER['code_editor_neutral']
						//          
						//   ),
				...
				#Primary Key
				 ...
				 "default_fields"=>array("entity_code" => "TP"),
				...
				'back_to'  => array( 'is_back_button' =>0, 'back_link'=>'?d=create_theme__template', 'BACK_NAME'=>'Back'),
     ...
     function before_add_update($param){
	  ...
	  //if($param['X3']==''){
	  //     
	  //      $F_SERIES['after_add_update'] = 1;
	  //
	  //}else{
	  
	       $F_SERIES['data'][6]['location'] = $file.'/';
