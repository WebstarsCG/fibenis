    ...
    function ex_edit(input) {
        ...
        window.location = '?f=ext_at_addon&menu_off=0&default_addon='+data[1]+'&key='+data[0],"_blank",'width=800,height=600,left=10,top=50,toolbar=0,scrollbars=1,menubar=0,status=0';
    }